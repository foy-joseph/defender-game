public class Mutant extends Alien
{
  ...
  public String toString(){
    return "[MUTANT:number="+super.getNumber()+" ,location=[Location:x="+super.location.getX()+", y="+super.location.getY()+"], speed="+super.speed+", direction="+direction+"]";
  }
  ...
  public void display() // CAREFUL HOW/IF YOU MODIFY THIS CODE!!
  {
    ...
    rect(10,0,Game.BLOCK_SIZE,Game.BLOCK_SIZE); 
    rect(Game.BLOCK_SIZE*1,10,Game.BLOCK_SIZE,Game.BLOCK_SIZE);                                                                              
    rect(10,20,Game.BLOCK_SIZE,Game.BLOCK_SIZE);
